...
const WEB_EXTENSION = join(getAgentDir(), "npm/node_modules/pi-web-access/index.ts");
...
export default function delegateExtension(pi: ExtensionAPI) {
  pi.registerTool({
    ...
    async execute(toolCallId, params, signal, onUpdate, ctx) {
      ...
      if (!params.provider && !params.model) args.push("--provider", DEFAULT_PROVIDER, "--model", DEFAULT_MODEL);
